...
import by.grsu.lancevich.postaloffice.web.security.AuthenticationFilter;
import by.grsu.lancevich.postaloffice.web.security.User;

public class LoginServlet extends HttpServlet {

	private static final List<User> USERS = new ArrayList<>();
	static {
		USERS.add(new User("admin", "123", "Ivan", "Ivanov"));
